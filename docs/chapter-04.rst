...
The Dashboard is the standard web based IDE; you will surely use it extensively to manage the applications and
check databases. Looking at its interface is a good way to start exploring py4web and its components.
...
Here you must insert the password that you've already setup (see :ref:`set_password command option`).
If you don't remember the password, you have to stop the program with CTRL-C, setup a new one and run the py4web again.
...
tab for the change to take effect (except if you use *watch* with the :ref:`run command option`).
If an app fails to load, its corresponding button is displayed in red. Click on it to see the
corresponding error.
...
.. |image1| image:: images/dashboard_login.png
   :width: 800px
   :height: 558px
.. |image2| image:: images/dashboard_main.png
   :width: 800px
   :height: 558px
.. |image3| image:: images/dashboard_edit.png
   :width: 800px
   :height: 558px
.. |image4| image:: images/dashboard_restapi.png
   :width: 800px
   :height: 558px
.. |image5| image:: images/dashboard_error.png
   :width: 800px
   :height: 558px
.. |image6| image:: images/dashboard_ticket.png
   :width: 800px
   :height: 558px
