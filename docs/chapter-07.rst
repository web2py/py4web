...
-  ``label`` is a string (or a helper or something that can be
   ...
   field in auto-generated forms.) that contains a comment associated 
   with this field, and will be displayed to the right of the input
   field in the autogenerated forms.
