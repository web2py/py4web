...
! function(e, t) {
    ...
    function k(e, t, i) {
        ...
        return t = E(t) || 0, v(i) && (h = !!i.leading, l = (d = "maxWait" in i) ? w(E(i.maxWait) || 0, t) : l, u = "trailing" in i ? !!i.trailing : u), y.cancel = function() {
    ...
    function A(e, t, i) {
        var s = !0,
            r = !0;
        if ("function" != typeof e) throw new TypeError("Expected a function");
        return v(i) && (s = "leading" in i ? !!i.leading : s, r = "trailing" in i ? !!i.trailing : r), k(e, t, {
            leading: s,
            maxWait: t,
            trailing: r
        })
    ...
    e && window.addEventListener("resize", (function() {
        M !== window.devicePixelRatio && (M = window.devicePixelRatio, L = null)
    }));
    var D = function() {
        function t(e) {
            var s = this,
            ...
            i(this, t), this.onScroll = function() {
                var e = N(s.el);
                s.scrollXTicking || (e.requestAnimationFrame(s.scrollX), s.scrollXTicking = !0), s.scrollYTicking || (e.requestAnimationFrame(s.scrollY), s.scrollYTicking = !0), s.isScrolling || (s.isScrolling = !0, s.el.classList.add(s.classNames.scrolling)), s.onStopScrolling()
                ...
                s.isMouseEntering || (s.el.classList.add(s.classNames.mouseEntered), s.isMouseEntering = !0), s.onMouseEntered()
            }, this.onMouseEntered = function() {
                s.el.classList.remove(s.classNames.mouseEntered), s.isMouseEntering = !1
                ...
                var t, i;
                s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect(), s.axis.y.track.rect = s.axis.y.track.el.getBoundingClientRect(), (s.axis.x.isOverflowing || s.axis.x.forceVisible) && (t = s.isWithinBounds(s.axis.x.track.rect)), (s.axis.y.isOverflowing || s.axis.y.forceVisible) && (i = s.isWithinBounds(s.axis.y.track.rect)), (t || i) && (e.stopPropagation(), "pointerdown" === e.type && "touch" !== e.pointerType && (t && (s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect(), s.isWithinBounds(s.axis.x.scrollbar.rect) ? s.onDragStart(e, "x") : s.onTrackClick(e, "x")), i && (s.axis.y.scrollbar.rect = s.axis.y.scrollbar.el.getBoundingClientRect(), s.isWithinBounds(s.axis.y.scrollbar.rect) ? s.onDragStart(e, "y") : s.onTrackClick(e, "y"))))
                ...
                "x" === s.draggedAxis && (a = s.isRtl && t.getRtlHelpers().isScrollOriginAtZero ? a - (r + l.size) : a), s.contentWrapperEl[s.axis[s.draggedAxis].scrollOffsetAttr] = a
                ...
                e.preventDefault(), e.stopPropagation()
            }, this.el = e, this.minScrollbarWidth = 20, this.stopScrollDelay = 175, this.options = T(T({}, t.defaultOptions), r), this.classNames = T({
            ...
            }, this.options.classNames), this.axis = {
                x: {
        ...
        return r = t, o = [{
            ...
            key: "init",
            value: function() {
                t.instances.set(this.el, this), e && (this.initDOM(), this.rtlHelpers = t.getRtlHelpers(), this.scrollbarWidth = t.getScrollbarWidth(), this.recalculate(), this.initListeners())
            }
        }, {
            key: "initDOM",
            value: function() {
            ...
            value: function() {
                ...
                this.axis.x.isOverflowing = this.axis.x.isOverflowing && a > r - d, this.axis.y.isOverflowing = this.axis.y.isOverflowing && n > c - h, this.axis.x.scrollbar.size = this.getScrollbarSize("x"), this.axis.y.scrollbar.size = this.getScrollbarSize("y"), this.axis.x.scrollbar.el.style.width = "".concat(this.axis.x.scrollbar.size, "px"), this.axis.y.scrollbar.el.style.height = "".concat(this.axis.y.scrollbar.size, "px"), this.positionScrollbar("x"), this.positionScrollbar("y"), this.toggleTrackVisibility("x"), this.toggleTrackVisibility("y")
            }
        }, {
            ...
            value: function() {
                ...
                var t, i = this.contentEl[this.axis[e].scrollSizeAttr],
                    ...
                    r = s / i;
                return t = Math.max(~~(r * s), this.options.scrollbarMinSize), this.options.scrollbarMaxSize && (t = Math.min(t, this.options.scrollbarMaxSize)), t
            }
        }, {
            ...
            value: function() {
                ...
                if (this.axis[e].isOverflowing) {
                    var i = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
                        ...
                        a = ~~((s - l.size) * n);
                    a = "x" === e && this.isRtl && t.getRtlHelpers().isScrollingToNegative ? -a + (s - l.size) : a, l.el.style.transform = "x" === e ? "translate3d(".concat(a, "px, 0, 0)") : "translate3d(0, ".concat(a, "px, 0)")
                }
            }
        }, {
            ...
            value: function() {
                ...
                this.axis[e].isOverflowing || this.axis[e].forceVisible ? (t.style.visibility = "visible", this.contentWrapperEl.style[this.axis[e].overflowAttr] = "scroll", this.el.classList.add("".concat(this.classNames.scrollable, "-").concat(e))) : (t.style.visibility = "hidden", this.contentWrapperEl.style[this.axis[e].overflowAttr] = "hidden", this.el.classList.remove("".concat(this.classNames.scrollable, "-").concat(e))), this.axis[e].isOverflowing ? i.style.display = "block" : i.style.display = "none"
            }
        }, {
            key: "hideNativeScrollbar",
            value: function() {
                this.offsetEl.style[this.isRtl ? "left" : "right"] = this.axis.y.isOverflowing || this.axis.y.forceVisible ? "-".concat(this.scrollbarWidth, "px") : 0, this.offsetEl.style.bottom = this.axis.x.isOverflowing || this.axis.x.forceVisible ? "-".concat(this.scrollbarWidth, "px") : 0
            }
        }, {
            key: "onMouseMoveForAxis",
            value: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "y";
                this.axis[e].track.rect = this.axis[e].track.el.getBoundingClientRect(), this.axis[e].scrollbar.rect = this.axis[e].scrollbar.el.getBoundingClientRect();
                var t = this.isWithinBounds(this.axis[e].scrollbar.rect);
                t ? this.axis[e].scrollbar.el.classList.add(this.classNames.hover) : this.axis[e].scrollbar.el.classList.remove(this.classNames.hover), this.isWithinBounds(this.axis[e].track.rect) ? this.axis[e].track.el.classList.add(this.classNames.hover) : this.axis[e].track.el.classList.remove(this.classNames.hover)
            }
        }, {
            ...
            value: function(e) {
                ...
                if (this.options.clickOnTrack) {
                    ...
                    var r = this.axis[i].scrollbar,
                        ...
                        d = 40,
                        u = function e() {
                            -1 === c ? n > h && (n -= d, t.contentWrapperEl[t.axis[i].scrollOffsetAttr] = n, s.requestAnimationFrame(e)) : n < h && (n += d, t.contentWrapperEl[t.axis[i].scrollOffsetAttr] = n, s.requestAnimationFrame(e))
                        };
                    u()
                }
            }
