    ...
    return t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStop: function(e) {
            ...
            var i, s, n, o, r, a, h, l = this.options,
                p = this;
            return this._helper && (i = this._proportionallyResizeElements, s = i.length && /textarea/i.test(i[0].nodeName), n = s && this._hasScroll(i[0], "left") ? 0 : p.sizeDiff.height, o = s ? 0 : p.sizeDiff.width, r = {
                width: p.helper.width() - o,
                height: p.helper.height() - n
        ...
        start: function() {
            var e, i, s, n, o, r, a, h = t(this).resizable("instance"),
                ...
                p = h.element,
                c = l.containment,
                d = c instanceof t ? c.get(0) : /parent/.test(c) ? p.parent().get(0) : c;
        ...
        resize: function() {
            var e, i = t(this).resizable("instance"),
                ...
                d = Math.round((n.height - o.height) / p) * p,
                u = o.width + c,
                f = o.height + d,
