! function t(e, r) {
    ...
    return function(t) {
        ...
        i = [r(2)], n = function(t) {
                            ...
                            if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C))) switch (v[C] = i.attr(C), null == v[C] && (v[C] = ft[C]), m[C] = l[C], pt[C]) {
                                ...
                                case "transform":
                                    var L = i._,
                                        F = le(L[C], m[C]);
                                    if (F)
                                        for (v[C] = F.from, m[C] = F.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length; B > w; w++)
                                            for (b[C][w] = [v[C][w][0]], E = 1, M = v[C][w].length; M > E; E++) b[C][w][E] = (m[C][w][E] - v[C][w][E]) / x;
                                    else {
            ...
            var Ne = [],
                Ee = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                    setTimeout(t, 16)
                },
                Me = function() {
                    for (var r = +new Date, i = 0; i < Ne.length; i++) {
                        ...
                        if (!n.el.removed && !n.paused) {
                            var a = r - n.start,
                                ...
                                d, g = {},
                                x;
                            if (n.initstatus ? (a = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * s, n.status = n.initstatus, delete n.initstatus, n.stop && Ne.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (a / s)) / n.anim.top, !(0 > a))
                                if (s > a) {
                                    var v = o(a / s);
                                    for (var y in l)
                                        if (l[T](y)) {
            ...
            var Fe = function(t) {
                    if (this.items = [], this.length = 0, this.type = "set", t)
                        for (var e = 0, r = t.length; r > e; e++) !t[e] || t[e].constructor != ye.constructor && t[e].constructor != Fe || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
                },
                Pe = Fe.prototype;
            Pe.push = function() {
