! function(t, e) {
    ...
    return function(t) {
            ...
            e[n ? "eachComponent" : "eachSeries"](function(t, o) {
                ...
                if (!l) {
                    var h = _.parseClassType(o.type),
                        u = n ? w.getClass(h.main, h.sub) : M.getClass(h.sub);
                    if (!u) return;
                ...
                this._zr.on(t, function(e) {
                    ...
                    if (i && null != i.dataIndex) {
                        var r = i.dataModel || n.getSeriesByIndex(i.seriesIndex),
                            a = r && r.getDataParams(i.dataIndex, i.dataType) || {};
        ...
        Y.init = function(t, e, n) {
            ...
            var i = A.isObject(t) ? t.type : [t, t = {
                event: e
            }][0];
            t.event = (t.event || i).toLowerCase(), e = t.event, R[i] || (R[i] = {
                action: n,
                actionInfo: t
            }), N[e] = i
        ...
        function l(t, e) {
            ...
            for (var o = 0; n > o; o++)
                for (var l = 0; l < i.length; l++) t = t.replace(s(d[l], o), e[o][i[l]]);
            return t
        }
        ...
        }), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, i), a.mixin(u, n(115)), t.exports = u
    }, function(t, e, n) {
        "use strict";
        ...
        (function(e) {
            ...
            y.type = "list", y.getDimension = function(t) {
                ...
                for (var e = this.dimensions, n = this._dimensionInfos, i = 0, r = e.length; r > i; i++)
                ...
                for (var l = 0; l < s.length; l++)
                    if (0 === o) e.call(r, l);
                    else if (1 === o) e.call(r, this.get(t[0], l, n), l);
                else {
        ...
        function u(t) {
            var e = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
                ...
                a = .5 >= r ? r * (i + 1) : r + i - r * i,
                l = 2 * r - a,
                h = [n(255 * s(l, a, e + 1 / 3)), n(255 * s(l, a, e)), n(255 * s(l, a, e - 1 / 3))];
        ...
        function g(t, e, i) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var a = t * (e.length - 1),
                    ...
                    c = h(e[s]),
                    f = a - o,
                    d = y([n(l(u[0], c[0], f)), n(l(u[1], c[1], f)), n(l(u[2], c[2], f)), r(l(u[3], c[3], f))], "rgba");
                return i ? {
                    color: d,
                    leftIndex: o,
                    rightIndex: s,
        ...
        function a(t, e, n) {
            ...
            var m, y = s && s.categoryAxisModel,
                x = "ordinal" === f[0].type ? 0 : "ordinal" === f[1].type ? 1 : -1,
                _ = new h(f, e),
                b = l(s, t),
                w = y && r(t) ? function(t, e, n, i) {
            ...
            l = a.extend({
                ...
                getTicks: function() {
                    ...
                    if (t) {
                        ...
                        e[0] < a[0] && n.push(e[0]);
                        for (var o = a[0]; o <= a[1];)
                            if (n.push(o), o = i.round(o + t), n.length > r) return [];
                        e[1] > a[1] && n.push(e[1])
                    }
                    return n
                },
                ...
                niceTicks: function(t) {
                    ...
                    if (isFinite(n)) {
                        0 > n && (n = -n, e.reverse());
                        var r = i.nice(n / t, !0),
                            a = [i.round(s(e[0] / r) * r), i.round(o(e[1] / r) * r)];
        ...
        s.updateData = function(t, e) {
            ...
            t.diff(o).add(function(i) {
                ...
                var u = o.getItemGraphicEl(h),
                    c = t.getItemLayout(l);
                return r(t, l, e) ? (u ? (u.updateData(t, l), a.updateProps(u, {
                    position: c
                }, i)) : (u = new s(t, l), u.attr("position", c)), n.add(u), void t.setItemGraphicEl(l, u)) : void n.remove(u)
            }).remove(function(t) {
            ...
            brush: function(t) {
                ...
                if (e = "string" == typeof i ? this._image : i, !e && i) {
                    ...
                    if (!r) return e = new Image, e.onload = function() {
                        ...
                        image: e,
                        pending: [this]
                    }, e.src = i, h.put(i, r), void(this._image = e);
        ...
        u._createSymbol = function(t, e, n) {
            ...
            l.initProps(h, {
                scale: u
            }, r, n), this._symbolType = t, this.add(h)
        ...
        var p = {
                ...
                axisTick: function() {
                    ...
                    if (t.get("axisTick.show")) {
                        for (var e = t.axis, n = t.getModel("axisTick"), i = this.opt, r = n.getModel("lineStyle"), a = n.get("length"), o = v(n, i.labelInterval), l = e.getTicksCoords(), h = [], u = 0; u < l.length; u++)
                            if (!g(e, u, o)) {
                                var c = l[u];
                ...
                axisLabel: function() {
                    ...
                    if (e.get("axisLabel.show")) {
                        ...
                        for (var v = r(n, p, n.labelDirection), m = e.get("data"), y = [], x = e.get("silent"), _ = 0; _ < c.length; _++)
                            if (!g(a, _, n.labelInterval)) {
                                var b = h;
                                m && m[_] && m[_].textStyle && (b = new l(m[_].textStyle, h, e.ecModel));
                                var w = b.getTextColor(),
                                    M = a.dataToCoord(c[_]),
                                    S = [M, n.labelOffset + n.labelDirection * u],
                ...
                axisName: function() {
                    ...
                    if (null == n && (n = e.get("name")), n) {
                        var o, l = e.get("nameLocation"),
                            h = t.nameDirection,
                            u = e.getModel("nameTextStyle"),
                            c = e.get("nameGap") || 0,
                            f = this.axisModel.axis.getExtent(),
                            d = f[0] > f[1] ? -1 : 1,
                            p = ["start" === l ? f[0] - d * c : "end" === l ? f[1] + d * c : (f[0] + f[1]) / 2, "middle" === l ? t.labelOffset + h * c : 0];
            ...
            function r(n) {
                return function(r, h) {
                    if (i(r, t, e)) {
                        ...
                        var f = new c(n, l.createScaleByModel(r), [0, 0], r.get("type"), u),
                            d = "category" === f.type;
        ...
        function s(t, e, n, i, r) {
            var o = t.length;
            if (1 == r)
                for (var s = 0; o > s; s++) i[s] = a(t[s], e[s], n);
            else
                for (var l = t[0].length, s = 0; o > s; s++)
                    for (var h = 0; l > h; h++) i[s][h] = a(t[s][h], e[s][h], n)
        }
        ...
        function l(t, e, n) {
            ...
            if (i !== r) {
                ...
                if (a) t.length = r;
                    ...
                    for (var o = i; r > o; o++) t.push(1 === n ? e[o] : x.call(e[o]))
            }
        ...
        function u(t, e, n, i, r, a, o, s, l) {
            var h = t.length;
            if (1 == l)
                for (var u = 0; h > u; u++) s[u] = c(t[u], e[u], n[u], i[u], r, a, o);
            else
                for (var f = t[0].length, u = 0; h > u; u++)
                    for (var d = 0; f > d; d++) s[u][d] = c(t[u][d], e[u][d], n[u][d], i[u][d], r, a, o)
        }
            ...
            if (x) {
                ...
                if (!L) {
                    ...
                    var W = function(t, e) {
                            ...
                            if (0 !== i)
                                if (E = (e - A[n]) / i, m)
                                    if (R = C[n], B = C[0 === n ? n : n - 1], N = C[n > x - 2 ? x - 1 : n + 1], F = C[n > x - 3 ? x - 1 : n + 2], w) u(B, R, N, F, E, E * E, E * E * E, f(t, r), T);
                                    else {
                                        var l;
                                        if (M) l = u(B, R, N, F, E, E * E, E * E * E, q, 1), l = d(q);
                                        else {
                                            if (S) return o(R, N, E);
                            ...
                            else if (w) s(C[n], C[n + 1], E, f(t, r), T);
                            else {
                                var l;
                                if (M) s(C[n], C[n + 1], E, q, 1), l = d(q);
                                else {
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    o.each(function(t) {
                        ...
                        if (l) a.setItemVisual(s, "color", l);
                            ...
                            var h = r ? r[s % r.length] : n[(s + i) % n.length],
        ...
        r.extend(n(12).prototype, n(82)), t.exports = n(2).extendChartView({
                ...
                function o(e, n) {
                    ...
                    if (d) {
                        var u = h.shape,
                            c = f ? "height" : "width",
                            g = {};
                        u[c] = 0, g[c] = o[c], a[n ? "updateProps" : "initProps"](h, {
                            shape: g
                        }, t, e)
                    }
                    return h
            ...
            _updateStyle: function(t, e, n) {
                ...
                e.eachItemGraphicEl(function(o, s) {
                    ...
                    var p = n ? c.height > 0 ? "bottom" : "top" : c.width > 0 ? "left" : "right",
        ...
        function h(t, e, n) {
            ...
            return e && (d.shape[o ? "width" : "height"] = 0, v.initProps(d, {
                shape: {
                    width: h,
                    height: u
                }
        ...
        t.exports = y.extend({
            ...
            render: function(t, e, n) {
                ...
                T && T.eachItemGraphicEl(function(t, e) {
                    ...
                    t.stopAnimation(!0)
                }), i(this._stackedOnPoints, w) && i(this._points, d) || (_ ? this._updateAnimation(l, w, a, n) : (m.setShape({
                    points: d
                }), y && y.setShape({
                    points: d,
                    stackedOnPoints: w
            ...
            _updateAnimation: function(t, e, n, i) {
                var r = this._polyline,
                    a = this._polygon,
                    o = t.hostModel,
                    s = g(this._data, t, this._stackedOnPoints, e, this._coordSys, n);
                r.shape.points = s.current, v.updateProps(r, {
                    shape: {
                        points: s.next
                    }
                }, o), a && (a.setShape({
        ...
        function r(t, e, n, r, a, o, g, v, m, y, x) {
            for (var _ = 0, b = n, w = 0; r > w; w++) {
                ...
                if (b === n) t[o > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(d, M);
                else if (m > 0) {
                    var S = b + o,
                        T = e[S];
                    if (x)
                        for (; T && i(e[S]);) S += o, T = e[S];
                    var A = .5,
                        C = e[_],
                        T = e[S];
                    if (!T || i(T)) c(p, M);
        ...
        h.updateData = function(t, e, n) {
            ...
            var o = this.childAt(0),
                ...
                c = t.getItemLayout(e),
                f = l.extend({}, c);
            f.label = null, n ? (o.setShape(f), o.shape.endAngle = c.startAngle, s.updateProps(o, {
                shape: {
                    endAngle: c.endAngle
                }
            }, h, e)) : s.updateProps(o, {
            ...
            o.useStyle(l.defaults({
                fill: p
            }, d.getModel("normal").getItemStyle())), o.hoverStyle = d.getModel("emphasis").getItemStyle(), r(this, t.getItemLayout(e), u.get("selected"), h.get("selectedOffset"), h.get("animation")), o.off("mouseover").off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && o.on("mouseover", i).on("mouseout", a).on("emphasis", i).on("normal", a), this._updateLabel(t, e), s.setHoverStyle(this)
                ...
                for (var o = a > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, s = 0, l = t.length; l > s; s++)
                    if ("center" !== t[s].position) {
                        var h = Math.abs(t[s].y - i),
                            u = t[s].len,
                            c = t[s].len2,
                            f = r + u > h ? Math.sqrt((r + u + c) * (r + u + c) - h * h) : Math.abs(t[s].x - n);
        ...
        t.exports = function(t, e, n, i) {
            var o, s, l = t.getData(),
                ...
                u = !1;
            l.each(function(n) {
                var i, r, c, f, d = l.getItemLayout(n),
                    p = l.getItemModel(n),
            ...
            c = n(2).extendComponentView({
                ...
                _splitLine: function(t, e, n) {
                    var i = t.axis,
                        ...
                        f = l(o, n);
                    c = r.isArray(c) ? c : [c];
                    for (var d = e.coordinateSystem.getRect(), p = i.isHorizontal(), g = [], v = 0, m = i.getTicksCoords(), y = [], x = [], _ = 0; _ < m.length; _++)
                        if (!s(i, _, f)) {
        ...
        function a(t, e, n) {
            ...
            e.eachSeriesByType(t, function(t) {
                var e = t.getData(),
                    ...
                    d = r.onZero ? c.toGlobalCoord(c.dataToCoord(0)) : c.getGlobalExtent()[0],
                    p = n.dataToPoints(e, !0);
                s[o] = s[o] || [], e.setLayout({
                    offset: h,
                    size: u
                }), e.each(c.dim, function(t, n) {
                    if (!isNaN(t)) {
                        s[o][n] || (s[o][n] = {
                            p: d,
                            n: d
                        });
                        var i, r, a, l, g = t >= 0 ? "p" : "n",
                            v = p[n],
                            m = s[o][n][g];
        ...
        function o(t, e) {
            ...
            p(e, function(t, e) {
                ...
                var i = t.exist,
                    ...
                    a = t.keyInfo;
                if (x(r)) {
                    if (a.name = null != r.name ? r.name + "" : i ? i.name : "\x00-", i) a.id = i.id;
        ...
        t.exports = function(t) {
            if (t) {
                ...
                if (e) {
                    ...
                    var a = t.markPoint;
                    if (a && a.data)
                        for (var o = a.data, n = 0; n < o.length; n++) i(o[n]);
                    var s = t.markLine;
                    if (s && s.data)
        ...
        T.prototype = {
            ...
            findHover: function(t, e, n) {
                for (var i = this.storage.getDisplayList(), r = i.length - 1; r >= 0; r--)
                    if (!i[r].silent && i[r] !== n && !i[r].ignore && o(i[r], t, e)) return i[r]
            }
        ...
        h.prototype = {
            ...
            _animateToShallow: function(t, e, n, i, a) {
                var o = {},
                    l = 0;
                for (var h in n)
                    if (null != e[h]) s(n[h]) && !r.isArrayLike(n[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], n[h], i, a) : (o[h] = n[h], l++);
                    else if (null != n[h])
                    if (t) {
                        var u = {};
