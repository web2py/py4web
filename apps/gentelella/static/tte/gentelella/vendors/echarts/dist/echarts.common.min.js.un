! function(t, e) {
    ...
    return function(t) {
        ...
        }), s.enableSubTypeDefaulter(c), s.enableTopologicalTravel(c, n), o.mixin(c, i(115)), t.exports = c
    }, function(t, e, i) {
        "use strict";
        ...
        c._createSymbol = function(t, e, i) {
            ...
            l.initProps(h, {
                scale: c
            }, r, i), this._symbolType = t, this.add(h)
            ...
            if (x) {
                ...
                if (!k) {
                    ...
                    var Z = function(t, e) {
                            ...
                            if (0 !== n)
                                if (E = (e - T[i]) / n, v)
                                    if (B = C[i], R = C[0 === i ? i : i - 1], N = C[i > x - 2 ? x - 1 : i + 1], V = C[i > x - 3 ? x - 1 : i + 2], w) c(R, B, N, V, E, E * E, E * E * E, d(t, r), A);
                                    else {
                                        var l;
                                        if (M) l = c(R, B, N, V, E, E * E, E * E * E, H, 1), l = f(H);
                                        else {
                                            if (S) return a(B, N, E);
            ...
            if (e || i || !n.ignore) {
                ...
                if (this.__dirty || a.__dirty) {
                    ...
                    if (!n.ignore) {
                        n.attr("position", h);
                        var f, p, g, m = 5 * r;
                        if ("end" === n.__position) f = [u[0] * m + h[0], u[1] * m + h[1]], p = u[0] > .8 ? "left" : u[0] < -.8 ? "right" : "center", g = u[1] > .8 ? "top" : u[1] < -.8 ? "bottom" : "middle";
        ...
        function r(t, e, i, r, o, a, g, m, v, y, x) {
            for (var _ = 0, b = i, w = 0; r > w; w++) {
                ...
                if (b === i) t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), u(f, M);
                else if (v > 0) {
                    var S = b + a,
                        A = e[S];
                    if (x)
                        for (; A && n(e[S]);) S += a, A = e[S];
                    var T = .5,
                        C = e[_],
                        A = e[S];
                    if (!A || n(A)) u(p, M);
        ...
        h.prototype = {
            ...
            _animateToShallow: function(t, e, i, n, o) {
                var a = {},
                    l = 0;
                for (var h in i)
                    if (null != e[h]) s(i[h]) && !r.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, o) : (a[h] = i[h], l++);
                    else if (null != i[h])
                    if (t) {
                        var c = {};
        ...
        var l = i(1),
            ...
            v = function(t, e, i, n) {
                ...
                if (!l.isArray(n) && ("min" === o || "max" === o || "average" === o || null != n.xAxis || null != n.yAxis)) {
                    var a, s, h;
                    if (null != n.yAxis || null != n.xAxis) s = null != n.yAxis ? "y" : "x", a = e.getAxis(s), h = l.retrieve(n.yAxis, n.xAxis);
                    else {
        ...
        function h(t, e, i, n, r, o, a) {
            ...
            if (o && u.applyTransform(o.transform), "function" == typeof t && (t = t([e, i], r, n.el, u)), f.isArray(t)) e = m(t[0], h), i = m(t[1], c);
        ...
        i(2).extendComponentView({
            ...
            _showAxisTooltip: function(t, e, i) {
                ...
                f.each(this._seriesGroupByAxis, function(t) {
                    ...
                    var p = !1,
                        g = this._lastHover;
                    if ("cross" === o) n(g.data, c) && (p = !0), g.data = c;
                    else {
                        var m = f.indexOf(l, d);
            ...
            _showCartesianPointer: function(t, e, i, n) {
                ...
                var l = this,
                    h = t.get("type"),
                    c = "cross" !== h;
                if ("cross" === h) a("x", n, e.getAxis("y").getGlobalExtent()), a("y", n, e.getAxis("x").getGlobalExtent()), this._updateCrossText(e, n, t);
                else {
            ...
            _showPolarPointer: function(t, e, i, n) {
                ...
                var l = this,
                    ...
                    u = e.getRadiusAxis(),
                    f = "cross" !== h;
                if ("cross" === h) o("angle", n, u.getExtent()), o("radius", n, c.getExtent()), this._updateCrossText(e, n, t);
                else {
        ...
        if (!i(14).canvasSupported) {
            ...
            c.prototype.brushVML = function(t) {
                ...
                if (r) {
                    ...
                    var W = G.style;
                    if (S) {
                        if (e && i) W.width = g(L * e * u / f) + "px", W.height = g(P * i * d / v) + "px";
                        else {
                            var q = new Image,
                                j = this;
                            q.onload = function() {
                    ...
                    if (o) {
                        ...
                        if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n) a = e.x, l = e.y;
                            ...
                            var v = r.textPosition,
                                y = r.textDistance;
                            if (v instanceof Array) a = e.x + z(v[0], e.width), l = e.y + z(v[1], e.height), h = h || "left", d = d || "top";
                            else {
