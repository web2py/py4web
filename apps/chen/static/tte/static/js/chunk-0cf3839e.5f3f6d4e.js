        ...
        "40b4": function(t, e, a) {
            ...
            var n = function() {
                    ...
                    return a("div", {
                        ...
                        staticClass: "example",
                        attrs: {
                            "start-val": t._startVal,
                            "end-val": t._endVal,
                            duration: t._duration,
                            decimals: t._decimals,
                            separator: t._separator,
                            prefix: t._prefix,
                            suffix: t._suffix,
                            autoplay: !1
                        }
                        ...
                        staticClass: "startBtn example-btn",
                        on: {
                            click: t.start
                        }
                    }, [t._v(" Start ")]), a("div", {
                    ...
                    }, [t._v(" pause/resume ")]), a("br"), a("label", {
                        staticClass: "label",
                        attrs: {
                            for: "decimalsInput"
                        }
                    }, [t._v("decimals: "), a("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model.number",
                            value: t.setDecimals,
                    ...
                    }, [t._v("separator: "), a("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model",
                            value: t.setSeparator,
                    ...
                    })])]), a("aside", [t._v("<count-to :start-val='" + t._s(t._startVal) + "' :end-val='" + t._s(t._endVal) + "' :duration='" + t._s(t._duration) + "' :decimals='" + t._s(t._decimals) + "' :separator='" + t._s(t._separator) + "' :prefix='" + t._s(t._prefix) + "' :suffix='" + t._s(t._suffix) + "' :autoplay=false>")])], 1)
                },
                i = [function() {
                    var t = this,
                        e = t.$createElement,
                ...
                u = o,
                l = (a("19fd"), a("2877")),
                c = Object(l["a"])(u, n, i, !1, null, "21d12dce", null);
            e["default"] = c.exports
        },
        "50e9": function(t, e, a) {},
        ec1b: function(t, e, a) {
            ! function(e, a) {
                ...
                return function(t) {
                    ...
                    var n = 0,
                        ...
                        r = void 0,
                        s = void 0;
                    if ("undefined" == typeof window) e.requestAnimationFrame = r = function() {}, e.cancelAnimationFrame = s = function() {};
                    else {
                        e.requestAnimationFrame = r = window.requestAnimationFrame, e.cancelAnimationFrame = s = window.cancelAnimationFrame;
                        for (var o = void 0, u = 0; u < i.length && (!r || !s); u++) o = i[u], e.requestAnimationFrame = r = r || window[o + "RequestAnimationFrame"], e.cancelAnimationFrame = s = s || window[o + "CancelAnimationFrame"] || window[o + "CancelRequestAnimationFrame"];
                        r && s || (e.requestAnimationFrame = r = function(t) {
                            ...
                            return n = e + a, i
                        }, e.cancelAnimationFrame = s = function(t) {
                            window.clearTimeout(t)
                        })
                    }
                    e.requestAnimationFrame = r, e.cancelAnimationFrame = s
                }, function(t, e) {
                    t.exports = function(t, e, a, n) {
                        ...
                        if (e && (o.render = e.render, o.staticRenderFns = e.staticRenderFns), a && (o._scopeId = a), n) {
                            var u = Object.create(o.computed || null);
