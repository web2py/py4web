        ...
        "9ed6": function(t, e, n) {
            ...
            var s = function() {
                    ...
                    return n("div", {
                        ...
                        staticClass: "title"
                    }, [t._v("Login Form")])]), n("el-form-item", {
                        attrs: {
                            prop: "username"
                        }
                    }, [n("span", {
                        ...
                        nativeOn: {
                            click: function(e) {
                                return e.preventDefault(), t.handleLogin(e)
                            }
                        }
                    }, [t._v("Login")]), n("div", {
                        staticStyle: {
                        ...
                        staticClass: "tips"
                    }, [n("span", [t._v("Username : admin")]), n("span", [t._v("Password : any")])]), n("div", {
                        staticClass: "tips"
                    }, [n("span", {
                        staticStyle: {
                            "margin-right": "18px"
                        }
                    }, [t._v("Username : editor")]), n("span", [t._v("Password : any")])]), n("el-button", {
                    ...
                    }, [t._v(" Or connect with ")])], 1)], 1), n("el-dialog", {
                        attrs: {
                    ...
                    }, [t._v(" Can not be simulated on local, so please combine you own business simulation! ! ! "), n("br"), n("br"), n("br"), n("social-sign")], 1)], 1)
                },
                o = [],
                i = (n("13d5"), n("b64b"), n("61f7")),
                a = function() {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                ...
                l = c,
                u = (n("d9fb"), n("2877")),
                p = Object(u["a"])(l, a, r, !1, null, "7309fbbb", null),
                d = p.exports,
                f = {
                    name: "Login",
                    components: {
                    ...
                    data: function() {
                        var t = function(t, e, n) {
                                Object(i["e"])(e) ? n() : n(new Error("Please enter the correct user name"))
                            },
                            e = function(t, e, n) {
                                e.length < 6 ? n(new Error("The password can not be less than 6 digits")) : n()
                            };
                        return {
                            loginForm: {
                                username: "admin",
                    ...
                    watch: {
                        $route: {
                            handler: function(t) {
                                var e = t.query;
                                e && (this.redirect = e.redirect, this.otherQuery = this.getOtherQuery(e))
                            },
                            immediate: !0
                        }
                    },
                    ...
                    destroyed: function() {},
                    methods: {
                        checkCapslock: function(t) {
                            var e = t.key;
                            this.capsTooltip = e && 1 === e.length && e >= "A" && e <= "Z"
                        },
                        showPwd: function() {
                            var t = this;
                        ...
                        getOtherQuery: function(t) {
                            return Object.keys(t).reduce((function(e, n) {
                                return "redirect" !== n && (e[n] = t[n]), e
                            }), {})
                        }
                    }
                },
                m = f,
                g = (n("2017"), n("fa2f"), Object(u["a"])(m, s, o, !1, null, "b678bd42", null));
            e["default"] = g.exports
        },
        a9b3: function(t, e, n) {},
        cafe: function(t, e, n) {},
