"""
This file defines actions for the _dashboard app.
"""
...
from py4web.core import DAL, Reloader, dumps, error_logger, safely
from py4web.utils.grid import Grid
from yatl.helpers import A

from .common import T, authenticated, catch_errors, logged, session, session_secured
from .diff2kryten import diff2kryten
from .models import make_safe
from .settings import APP_NAMES, FOLDER, MODE, PY4WEB_IGNORE
from .utils import *
...
def run(command, project):
    """for running git commands inside an app (project)"""
...
if MODE in ("demo", "readonly", "full"):
    ...
    @action.uses(logged, "dbadmin.html")
    def dbadmin():
...
if MODE == "full":
    ...
    @action.uses(logged, "gitlog.html")
    @catch_errors
    def gitlog(project):
    ...
    @action.uses(logged, "gitshow.html")
...
@action.uses(logged, "translations.html")
