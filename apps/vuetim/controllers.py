...
#
# AI-biorex, 14:12:11 22.12.2020 UTC+3
# src: https://github.com/creativetimofficial/vue-material-dashboard 
#
...
def before_request():
    bad_path= '/vuetim/static/tte/vuetim/static/tte/'
    bad_root='/vuetim/vuetim/'
    if bottle.request.environ["PATH_INFO"].startswith(bad_path):
        bottle.request.environ["PATH_INFO"]= bottle.request.environ["PATH_INFO"].replace( '/vuetim/static/tte', '', 1)
        print ( f'before_request:    /vuetim: goto {bottle.request.environ["PATH_INFO"]}' )
    elif bottle.request.environ["PATH_INFO"].startswith(bad_root):
        bottle.request.environ["PATH_INFO"]= bottle.request.environ["PATH_INFO"].replace( '/vuetim', '', 1)
        print ( f'before_request:    /vuetim: goto {bottle.request.environ["PATH_INFO"]}' )
...
#
# curl -X  GET   http://localhost:8000/vuetim/api/test_table/
# curl -X  GET   http://localhost:8000/vuetim/api/test_table/9
# curl -X DELETE  http://localhost:8000/vuetim/api/test_table/2
# curl -X POST -d 'f0=1111111&f1=2222222222&f2=33333333333' http://localhost:8000/vuetim/api/test_table/
# curl -X PUT -d 'f0=1111111&f1=2222222222&f2=33333333333' http://localhost:8000/vuetim/api/test_table/19
# curl -X POST -d f0=1111111   -d f1=2222222222 -d f2=8888888888  http://localhost:8000/vuetim/api/test_table/
#
#  pip install httpie
#  http         localhost:8000/vuetim/api/test_table/
#  http -f POST localhost:8000/vuetim/api/test_table/ f0=111111 f1=2222222 f2=333333
#  http -f DELETE localhost:8000/vuetim/api/test_table/2
#  http -f PUT localhost:8000/vuetim/api/test_table/2 f0=111111 f1=2222222 f2=333333
