        ...
        a05b: function(t, e, a) {
            ...
            var i = function() {
                    var t = this,
                        ...
                        a = t._self._c || e;
                    return a("div", {
                        staticClass: "va-page-not-found justify--center pb-5",
                        style: t.pageNotFoundStyle
                    }, [a("div", {
                        staticClass: "va-page-not-found__inner align--center"
                    }, [t._t("image"), a("div", {
                        staticClass: "va-page-not-found__title text--center mb-4"
                    }, [t._v(t._s(t.$t("404.title")))]), a("div", {
                        staticClass: "va-page-not-found__text px-4 text--center"
                    }, [a("span", [t._v(" " + t._s(t.$t("404.text")) + " ")]), a("a", {
                        staticClass: "link",
                        style: {
                    ...
                    }, [t._v("hello@epicmax.co")])]), t._t("default"), t.withoutButton ? t._e() : a("va-button", {
                        attrs: {
                            to: {
                                name: "dashboard"
                            }
                        }
                    }, [t._v(t._s(t.$t("404.back_button")))])], 2), a("made-by-component"), a("div", {
                        staticClass: "va-page-not-found__wallpaper"
                    }, [a("wallpaper", {
                        attrs: {
                            color: t.wallpaperColor
                        }
                    })], 1)], 1)
                },
                n = [],
                ...
                m = [function() {
                    var t = this,
                        ...
                        a = t._self._c || e;
                    return a("div", {
                        staticClass: "made-by-component text--center pb-3"
                    }, [a("span", [t._v(" ©2019. Made by "), a("a", {
                        staticClass: "link",
                        attrs: {
                ...
                r = o,
                c = (a("fe73"), a("2877")),
                l = Object(c["a"])(r, s, m, !1, null, null, null),
                u = l.exports,
                p = function() {
                    var t = this,
                        e = t.$createElement,
                ...
                h = f,
                g = (a("c9e5"), Object(c["a"])(h, p, d, !1, null, "7fba59f2", null)),
                v = g.exports,
                k = a("9d2c"),
                b = {
                    ...
                    computed: {
                        ...
                        wallpaperColor: function() {
                            return this.contextConfig.invertedColor ? this.$themes.dark : "#e4ff32"
                        }
                    }
                },
                _ = b,
                N = (a("ad40"), Object(c["a"])(_, i, n, !1, null, null, null));
            e["a"] = N.exports
        },
        ad40: function(t, e, a) {
            "use strict";
        ...
        e93f: function(t, e, a) {
            ...
            var i = function() {
                    var t = this,
                        e = t.$createElement,
                        a = t._self._c || e;
                    return a("va-page-not-found", {
                        staticClass: "va-page-not-found-search",
                        attrs: {
                            "without-button": ""
                        }
                    }, [
                        [a("va-input", {
                            staticClass: "va-page-not-found-search__input mb-4",
                            style: {
                            ...
                            staticClass: "row va-page-not-found-search__links"
                        }, t._l(t.filterItems, (function(e, i) {
                            return a("ul", {
                                key: i,
                                staticClass: "va-page-not-found-search__list flex xs3 lg1 mx-2 mb-2"
                            }, [t._v(" " + t._s(e.categoryName) + " "), t._l(e.items, (function(e, i) {
                                return a("li", {
                                    key: i,
                                    staticClass: "va-page-not-found-search__list-element"
                                }, [a("router-link", {
                                    staticClass: "link",
                                    attrs: {
                                        to: {
                ...
                o = {
                    ...
                    computed: {
                        filterItems: function() {
                            var t = this;
                            return this.inputValue.length >= 1 ? this.categories.map((function(e) {
                                return {
                                    categoryName: e.categoryName,
                                    items: e.items.filter((function(e) {
                                        return -1 !== e.itemName.toUpperCase().search(t.inputValue.toUpperCase())
                                    }))
                                }
                            })).filter((function(t) {
                ...
                r = o,
                c = (a("2fb4"), a("2877")),
                l = Object(c["a"])(r, i, n, !1, null, null, null);
            e["default"] = l.exports
        },
        fe73: function(t, e, a) {
            "use strict";
