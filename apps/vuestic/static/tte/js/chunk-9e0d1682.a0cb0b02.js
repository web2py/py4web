        ...
        1188: function(a, e, t) {
            ...
            var s = function() {
                    var a = this,
                        ...
                        t = a._self._c || e;
                    return t("div", {
                        staticClass: "markup-tables"
                    }, [t("va-card", {
                        staticClass: "mb-2",
                        attrs: {
                            title: a.$t("tables.basic")
                        }
                    }, [t("table", {
                        staticClass: "va-table"
                    }, [t("thead", [t("tr", [t("th", [a._v(a._s(a.$t("tables.headings.name")))]), t("th", [a._v(a._s(a.$t("tables.headings.email")))]), t("th", [a._v(a._s(a.$t("tables.headings.country")))]), t("th", [a._v(a._s(a.$t("tables.headings.status")))])])]), t("tbody", a._l(a.users, (function(e) {
                        return t("tr", {
                            key: e.id
                        }, [t("td", [a._v(a._s(e.name))]), t("td", [a._v(a._s(e.email))]), t("td", [a._v(a._s(e.country))]), t("td", [t("va-badge", {
                            attrs: {
                                color: a.getStatusColor(e.status)
                            }
                        }, [a._v(" " + a._s(e.status) + " ")])], 1)])
                    })), 0)])]), t("va-card", {
                        attrs: {
                            title: a.$t("tables.stripedHoverable")
                        }
                    }, [t("table", {
                        staticClass: "va-table va-table--striped va-table--hoverable"
                    }, [t("thead", [t("tr", [t("th", [a._v("Name")]), t("th", [a._v("Email")]), t("th", [a._v("Country")]), t("th", [a._v("Status")])])]), t("tbody", a._l(a.users, (function(e) {
                        return t("tr", {
                            key: e.id
                        }, [t("td", [a._v(a._s(e.name))]), t("td", [a._v(a._s(e.email))]), t("td", [a._v(a._s(e.country))]), t("td", [t("va-badge", {
                            attrs: {
                ...
                d = {
                    ...
                    methods: {
                        getStatusColor: function(a) {
                            return "paid" === a ? "success" : "processing" === a ? "info" : "danger"
                        }
                    }
                },
                i = d,
