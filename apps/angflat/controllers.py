...
#
# AI-biorex, 15:23:26 16.12.2020 UTC+3
...
def before_request():
    bad_path= '/angflat/static/tte/angflat/static/tte/'
    bad_root='/angflat/angflat/'
    print ( f'before_request:    /angflat:  {bottle.request.environ["PATH_INFO"]}' )
    if bottle.request.environ["PATH_INFO"].startswith(bad_path):
        bottle.request.environ["PATH_INFO"]= bottle.request.environ["PATH_INFO"].replace( '/angflat/static/tte', '', 1)
...
#
# curl -X  GET   http://localhost:8000/angflat/api/test_table/
# curl -X  GET   http://localhost:8000/angflat/api/test_table/9
# curl -X DELETE  http://localhost:8000/angflat/api/test_table/2
# curl -X POST -d 'f0=1111111&f1=2222222222&f2=33333333333' http://localhost:8000/angflat/api/test_table/
# curl -X PUT -d 'f0=1111111&f1=2222222222&f2=33333333333' http://localhost:8000/angflat/api/test_table/19
# curl -X POST -d f0=1111111   -d f1=2222222222 -d f2=8888888888  http://localhost:8000/angflat/api/test_table/
#
#  pip install httpie
#  http         localhost:8000/angflat/api/test_table/
#  http -f POST localhost:8000/angflat/api/test_table/ f0=111111 f1=2222222 f2=333333
#  http -f DELETE localhost:8000/angflat/api/test_table/2
#  http -f PUT localhost:8000/angflat/api/test_table/2 f0=111111 f1=2222222 f2=333333
